...
urlpatterns = [ url(r'^$', views.index, name='index'),
                ...
                url(r'^\d+/\d+\/(?P<spot_id>\d+)/add_wall$', views.add_wall, name='add wall'),
                url(r'^\d+/\d+/\d+/(?P<wall_id>\d+)/$', views.wall_detail, name='wall detail'),
                url(r'^\d+/\d+/\d+/(?P<wall_id>\d+)/route(?P<route_id>\d+)/edit$', views.route_edit, name='edit route'),
                url(r'^\d+/\d+/\d+/(?P<wall_id>\d+)/addroute$', views.route_add, name='add route'),
                url(r'^\d+/\d+/\d+/\d+/route(?P<route_id>\d+)$', views.route_detail, name='route detail'),
